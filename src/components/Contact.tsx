  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "mahahaksh0506@gmail.com",
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                I am currently looking for Software Developer/ Web Developer opportunities where I can contribute 
                my skills and continue learning. Whether you have a question or just want to say hi, 
